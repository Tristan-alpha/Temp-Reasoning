...
- First, we ask models in different temperatures to generate answers for problems in datasets. 
- Then, we use evaluators, such as ReasonEval and Math Shepherd, to evaluate the quality of the generated answers.
...
- Datasets: we adopted several datasets such as AIME 22-24, MATH and MR-GSM8K.
- Models: we used Abel, Wizard and Qwen3 0.6B, 4B, 8B, 14B models to do large-scale experiment. And calling APIs of Deepseek-V3 (0324), OpenAI models(GPT-4o-mini) in a smaller scale.
