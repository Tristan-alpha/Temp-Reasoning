...
python /home/dazhou/ReasonEval/t-codes/evaluate_results.py --gpu $gpu --models \"$model\" --dataset_name $DATASET --temperatures $temperature_group --model_size $MODEL_SIZE --reasoneval_path $REASONEVAL_PATH