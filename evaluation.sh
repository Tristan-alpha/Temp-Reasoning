...
MODEL_SIZE="34B"  # Default to 7B, can be changed to 34B if needed
...
echo "Running evaluation for $MODELS on dataset $DATASET with automatic GPU allocation"
...
echo "Evaluation completed for ${MODELS[@]} with automatic GPU allocation"